...
<section id="main" class="container 2xl:max-w-6xl xl:max-w-6xl mx-auto max-lg:mt-24 max-md:text-center">
  <div class="initiative flex relative mt-6 pb-60">
    <div>
      <h2 class="text-4xl font-extrabold mb-6 mt-36">КЛЮЧЕВЫЕ <b class="text-gradient">ИНИЦИАТИВЫ</b></h2>
      <p>Наша компания реализует проекты, направленные на решение<br>основных проблем в энергетической отрасли.</p>
    </div>
    <div>
      <img id="initiative-bg-1" class="bg right-0" src="{{asset('images/projects/initiative-bg-1.png')}}" width="620">
      <img id="initiative-zap" class="absolute" src="{{asset('images/projects/thunder.svg')}}">
      <img id="initiative-grid-solution" class="absolute" src="{{asset('images/projects/initiative-grid-solution.png')}}">

    </div>
    <img id="initiative-bg-2" class="bg bottom-0 w-full" src="{{asset('images/projects/initiative-bg-2.svg')}}">

  </div>

  <div class="projects mt-20 relative">
    <img class="bg bg-gradient left-[-479px] top-[-163px]" src="{{asset('images/projects/projects-gradient.svg')}}">
    <div class="flex">
      <h2 class="text-4xl font-extrabold mb-6 basis-2/5">НАШИ ТЕКУЩИЕ <b class="text-gradient">ЭНЕРГЕТИЧЕСКИЕ ПРОЕКТЫ</b></h2>
      <div class="grid grid-cols-2 gap-4 basis-3/5 text-white">
        <div class="relative">
          <img class="" src="{{asset("images/projects/projects-1.jpg")}}">
          <div class="label">
            <div>
        ...
        <div class="relative">
          <img class="" src="{{asset("images/projects/projects-2.jpg")}}">
          <div class="label">
            <div>
        ...
        <div class="relative">
          <img class="" src="{{asset("images/projects/projects-3.jpg")}}">
          <div class="label">
            <div>
        ...
        <div class="relative">
          <img class="" src="{{asset("images/projects/projects-4.jpg")}}">
          <div class="label">
            <div>
  ...
  <div class="modernization mt-20">
    <div class="grid grid-cols-2 gap-6">
      ...
      <div class="flex flex-col space-y-6 green-bg">
        ...
        <div class="box shadowed-light flex space-x-6 items-center px-6 py-y">
  ...
  <div class="future mt-20 box flex items-center gap-6 text-white pl-6 overflow-hidden">
    <div class="basis-1/2">
    ...
    <div class="basis-1/2 relative">
      ...
      <img
        ...
        class="relative mx-auto py-6 h-[490px]">
    </div>
  </div>
</section>

...
<section id="main" class="container lg:px-5 2xl:max-w-6xl xl:max-w-6xl mx-auto max-lg:mt-24 max-md:text-center">
  <div class="initiative flex flex-col gap-12 xl:gap-0 xl:flex-row relative mt-6 xl:pb-60">
    <div>
      <h2 class="text-4xl font-extrabold mb-6 lg:mt-36">{!!__('КЛЮЧЕВЫЕ <b class="text-gradient">ИНИЦИАТИВЫ</b>')!!}</h2>
      <p>{!!__('Наша компания реализует проекты, направленные на решение<br>основных проблем в энергетической отрасли.')!!}</p>
    </div>
  ...
  <div class="projects mt-20 relative">
    ...
    <div class="flex flex-col lg:flex-row">
      <h2 class="text-3.5xl md:text-4xl font-extrabold mb-6 basis-2/5">{!!__('НАШИ ТЕКУЩИЕ <b class="text-gradient">ЭНЕРГЕТИЧЕСКИЕ ПРОЕКТЫ</b>')!!}</h2>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 basis-3/5 text-white">
        <div class="relative">
          ...
          <div class="label">
            <div>
              <h4 class="text-xl font-bold">{{__('ТЭЦ-2 550МВт')}}</h4>
              <span class="uppercase">{{__('Алматы / Казахстан')}}</span>
            </div>
          </div>
        </div>
        <div class="relative">
          ...
          <div class="label">
            <div>
              <h4 class="text-xl font-bold">{{__('ТЭЦ 240 МВт')}}</h4>
              <span class="uppercase">{{__('Кызылорда / Казахстан')}}</span>
            </div>
          </div>
        </div>
        <div class="relative">
          ...
          <div class="label">
            <div>
              <h4 class="text-xl font-bold">{{__('ТЭЦ 750 МВт')}}</h4>
              <span class="uppercase">{{__('Комотини / Греция')}}</span>
            </div>
          </div>
        </div>
        <div class="relative">
          ...
          <div class="label">
            <div>
              <h4 class="text-xl font-bold">{{__('ТЭЦ 550 МВт')}}</h4>
              <span class="uppercase">{{__('Иетнут / Румыния')}}</span>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="modernization mt-20">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <div>
        <h2 class="text-4xl font-extrabold mb-6 basis-2/5">{!!__('ПРОЕКТ <br> <b class="text-gradient">МОДЕРНИЗАЦИИ ТЭЦ-2</b>')!!}</h2>
        <p class="font-semibold">{{__('это центральный элемент нашей стратегии')}}</p>
      ...
      <div class="flex flex-col space-y-6 green-bg">
        <div class="box shadowed-light flex space-x-6 items-center px-6 py-4">
          ...
          <p class="text-sm">{{__('Введение в эксплуатацию двух газотурбинных установок общей мощностью 350–400 МВт.')}}</p>
        </div>
        <div class="box shadowed-light flex space-x-6 items-center px-6 py-4">
          <img src="{{asset("images/projects/modernization-2.svg")}}">
          <p class="text-sm">{{__('Замена угольных котлов на парогазовые технологии, что снижает уровень загрязнения воздуха.')}}</p>
        </div>
        <div class="box shadowed-light flex space-x-6 items-center px-6 py-4">
          <img src="{{asset("images/projects/modernization-3.svg")}}">
          <p class="text-sm">{{__('Модернизация существующей сети для повышения надёжности подачи энергии.')}}</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="impact mt-20">
    <h2 class="text-4xl font-extrabold mb-6 basis-2/5">{!!__('СФЕРЫ <b class="text-gradient">ВОЗДЕЙСТВИЯ ПРОЕКТА</b>')!!}</h2>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-center">
      <div class="box shadowed-light p-4">
        ...
        <h4 class="font-bold text-xl mt-4 mb-2">{{__('Энергетическая безопасность')}}</h4>
        <p class="leading-tight text-sm">{{__('ТЭЦ обеспечит стабильное энергоснабжение в пиковые периоды.')}}</p>
      </div>
      <div class="box shadowed-light p-4">
        <div class="box green mb-4 py-4 rounded-xl">
          <img class="mx-auto" src="{{asset('images/projects/impact-2.svg')}}">
        </div>
        <h4 class="font-bold text-xl mt-4 mb-2">{{__('Экологическая устойчивость')}}</h4>
        <p class="leading-tight text-sm">{{__('Снижение выбросов парниковых газов и улучшение качества воздуха.')}}</p>
      </div>
      <div class="box shadowed-light p-4">
        <div class="box cyan mb-4 py-4 rounded-xl">
          <img class="mx-auto" src="{{asset('images/projects/impact-3.svg')}}">
        </div>
        <h4 class="font-bold text-xl mt-4 mb-2">{{__('Экономическое развитие')}}</h4>
        <p class="leading-tight text-sm">{{__('Создание более 1 000 рабочих мест в процессе строительства и более 200 на этапе эксплуатации.')}}</p>
      </div>
    </div>
  </div>
  ...
  <div class="future mt-20 box flex flex-col lg:flex-row-reverse items-center gap-6 text-white p-6 overflow-hidden">
    ...
    <div class="basis-1/2">
      <h2 class="text-4xl font-extrabold mb-6 basis-2/5">{!!__('БУДУЩИЕ <b class="text-gradient">ПЛАНЫ</b>')!!}</h2>
      <p class="leading-tight">{{__('Мы рассматриваем расширение проекта за счёт установки дополнительных газовых турбин, что позволит увеличить мощность станции до 500 МВт, обеспечивая дополнительные возможности для экспортной торговли электроэнергией.')}}</p>
    </div>
  </div>
</section>

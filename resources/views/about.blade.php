...
<section id="main" class="container 2xl:max-w-6xl xl:max-w-6xl mx-auto max-lg:mt-24 max-md:text-center">
  ...
  <div class="about flex items-center w-full linear-gradient text-white p-9">
    <div class="basis-1/2 mr-12 font-medium">Бишкекская газотурбинная теплоэлектроцентраль (ТЭЦ) является ключевым проектом в развитии энергетической инфраструктуры Кыргызской Республики.<br>
  ...
  <div class="mission flex items-center mt-20 space-x-12">
    ...
    <div class="basis-3/5">
      <img src="{{asset('images/about/mission-gradient.svg')}}" class="bg-gradient absolute right-0">
      <img src="{{asset('images/about/mission-bg.jpg')}}" class="bg absolute right-0">
  ...
  <div class="advantages mt-20">
    ...
    <div class="grid grid-cols-2 gap-4">
      ...
      <div class="grid grid-cols-1 gap-4">
        <div class="box shadowed-light flex items-center">
  ...
  <div class="achievements mt-20">
    ...
    <div class="grid grid-cols-3 gap-4">
      <div class="box shadowed-light p-6">
        <span class="num absolute text-6xl font-bold text-gradient">1</span>
      ...
      <div class="box shadowed-light p-6">
        <span class="num absolute text-6xl font-bold text-gradient">2</span>
        <img src="{{asset('images/about/achievements-2.svg')}}" class="mx-auto mb-6">
        <p class="text-sm leading-tight">Подписание стратегического соглашения с Кабинетом Министров Кыргызской Республики в 2024 году.</p>
      </div>
      <div class="box shadowed-light p-6">
        <span class="num absolute text-6xl font-bold text-gradient">3</span>
